    ...
    <div className='h-72 py-3' style={{"background": "rgb(0, 150, 150)"}}>
        <div className='mx-auto flex justify-between' style={{"width": "1120px"}}>
            ...
            <div className='w-64 text-white text-xl'>
                ...
                <span className='font-semibold'>{baseInfo.work_time_uz}</span>
                <div className='mt-3'>
                    <a href={`tel:${baseInfo.phone_number}`} className="inline-block mr-1">
                        <Image 
                    ...
                    <a href={baseInfo.telegram_link} className='inline-block mt-1.5 mr-2' target="_blank" rel="noreferrer">
                        <Image 
                          className='hover:cursor-pointer'
                          alt="telegram" 
                          src="/telegram.png"
