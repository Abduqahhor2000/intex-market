  ...
  return (
    <div className='bg-gray-bg'>
        ...
        <div className='mb-10 sm:mb-24 px-5 pb-7 sm:pb-8 text-center flex flex-col items-center text-white bg-green-main' >
            ...
            <span onClick={() => setConsul(true)} className='text-md sm:text-xl text-black pb-1 mt-6 sm:mt-8 px-10 rounded-oformit bg-yellow-btn font-semibold hover:cursor-pointer shadow-oformit  '>{lang === "RU" ? "Оформить заказ" : "Buyurtma berish"}</span>
        </div>
        <div className='sm:h-24 text-2xl sm:text-5xl font-bold py-5 text-center bg-green-transparent text-green-main '>
        ...
        <div className='flex text-black flex-col md:flex-row text-base min_lg:text-xl sm:text-2xl justify-center py-8 md:py-20'>
            <div className='px-5 min_lg:px-5 mb-8 w-full md:w-500'>
